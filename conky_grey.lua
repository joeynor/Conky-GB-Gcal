...
--     graph_bg_colour=0xFF6701,      graph_bg_alpha=0.0,
...
},
{
    ...
    graph_unit_angle=2.7,          graph_unit_thickness=1.8,
    graph_bg_colour=0x000000,      graph_bg_alpha=0.5,
    graph_fg_colour=0xFF0202,      graph_fg_alpha=0.9,
    hand_fg_colour=0x839097,       hand_fg_alpha=0.8,
    txt_radius=34,
...
{
    name='upspeedf',           arg='enp3s0f2',        max_value=100,
    x=220,                          y=280,
    graph_radius=42,
    graph_thickness=5,
    graph_start_angle=225,
...
{
    name='downspeedf',           arg='enp3s0f2',                max_value=100,
    x=220,                          y=280,
    graph_radius=62,
    graph_thickness=5,
    graph_start_angle=225,
